...
def generate_motion_TDBY(Ss, S1, soil_class, max_iterations=10, max_non_improvement=2, duration=40.0, dt=0.01, pga_='tdby', omega_g=15.0, zeta_g=0.6, name='default', imageoutput=False, damping=0.05, export_csv=True, export_json=True, export_sap2000=True, sap2000_two_column=False):
