...
def generate_motion_TDBY(Ss, S1, soil_class, omega_g, zeta_g, omega_f, zeta_f, t_rise_ratio, t_steady_ratio, decay_factor, max_iterations=2, max_non_improvement=1, duration=40.0, dt=0.01, pga_='tdby', name='default', imageoutput=False, damping=0.05, export_csv=True, export_json=True, export_sap2000=True, sap2000_two_column=False):
